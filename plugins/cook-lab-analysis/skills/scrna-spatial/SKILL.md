...
name: scrna-spatial
description: >
  Process and analyze single-cell RNA-seq and spatial transcriptomics data. Use for QC,
  filtering, normalization, clustering, annotation, doublet detection, and integration with
  Seurat, Scanpy, SpatialFeatureExperiment, Xenium, and Visium.
---
...
3. **SingleR** — Reference-based annotation (see `references/code_templates.md`)
...
To transfer cell type annotations from scRNA-seq to spatial data, use **SingleR**.

See `references/code_templates.md` → "Reference-Based Annotation (SingleR)" for the full code recipe.

---

## Data Export for Interoperability

For exporting Seurat objects to Cell Ranger format (loadable in Scanpy), see
`references/code_templates.md` → "Data Export for Interoperability".
...
For detailed code recipes (SingleR annotation transfer, Seurat → Cell Ranger export
for Scanpy interop), see `references/code_templates.md`.
