...
name: visualization
description: >
  Create publication-ready plots and figures in R/ggplot2. Use when making UMAPs, feature
  plots, heatmaps, violin plots, dot plots, spatial maps, or any data visualization. Includes
  lab theme, color palettes, cell-type colors, and export dimensions.
---
...
### Lab Cell Type Palette (v1.2)

*Canonical palette + full hex docs: `references/visualization_style_guide.md`.*
...
4. [ ] **Plot type appropriate?** No bar plots for distributions, no pie charts
5. [ ] **Theme clean?** No gridlines, no bold, no panel border
6. [ ] **UMAP/spatial params?** shape=16, size=0.1, alpha=0.8, raster.dpi=300
7. [ ] **Legend readable?** override.aes for small points
8. [ ] **Spatial aspect ratio?** coord_fixed()
9. [ ] **Heatmap square?** Explicit width/height with unit()

---

## Full Reference

See `references/visualization_style_guide.md` (bundled) for complete documentation including:
