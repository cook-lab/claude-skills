...
name: project-spec
description: >
  Create and update PROJECT_SPEC.md research project specifications. Guides structured
  documentation of research questions, goals, deliverables, data, collaborators, and timelines
  for scRNA-seq, spatial transcriptomics, biomarker, and methods projects.
---
...
The project spec template is bundled with this skill at `references/project_spec_template.md`.
Read it and follow its structure.
...
Save new project specs to: `[project-directory]/PROJECT_SPEC.md`
